...
/* ---------------------------------------------- Card inputs validation done here!!  ------------------------------*/

                    $("#nameoncard, #cr_no, #exp,#pass").on("keyup", function () {
                        if ($("#nameoncard").val() != "" && $("#cr_no").val() != "" && $("#cr_no").val().length == 19 && $("#exp").val() != "" && $("#exp").val().length == 5 && $("#pass").val() != "" && $("#pass").val().length == 3) {
                            $("button[type='submit']").removeClass("submitBtn");
